...
Ograničenja upotrebe za plaćene modele definirana su kao mjesečni iznosi u dolarima. Tabela ispod prikazuje mjesečno ograničenje i troškove tokena za svaki model.

Plaćeni modeli imaju sljedeća ograničenja upotrebe: 5 sati — 20% mjesečnog ograničenja; sedmično — 50%; i mjesečno — 100%.
