...
Forbrugsgrænser for betalingsmodeller defineres som månedlige beløb i dollars. Tabellen nedenfor viser den månedlige grænse og tokenpriserne for hver model.

Betalingsmodeller har følgende forbrugsgrænser: 5 timer — 20 % af den månedlige grænse; ugentligt — 50 %; og månedligt — 100 %.
