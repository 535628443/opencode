...
Nutzungslimits für kostenpflichtige Modelle werden als monatliche Dollarbeträge festgelegt. Die folgende Tabelle zeigt das monatliche Limit und die Tokenpreise für jedes Modell.

Für kostenpflichtige Modelle gelten folgende Nutzungslimits: 5 Stunden — 20 % des monatlichen Limits; wöchentlich — 50 %; und monatlich — 100 %.
