...
Los límites de uso de los modelos de pago se definen como importes mensuales en dólares. La siguiente tabla muestra el límite mensual y los costes de tokens de cada modelo.

Los modelos de pago tienen los siguientes límites de uso: 5 horas — 20 % del límite mensual; semanal — 50 %; y mensual — 100 %.
