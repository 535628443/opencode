...
Les limites d’utilisation des modèles payants sont définies sous forme de montants mensuels en dollars. Le tableau ci-dessous indique la limite mensuelle et les prix des tokens pour chaque modèle.

Les modèles payants sont soumis aux limites d’utilisation suivantes : 5 heures — 20 % de la limite mensuelle ; hebdomadaire — 50 % ; et mensuelle — 100 %.
