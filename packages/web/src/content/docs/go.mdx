...
Usage limits for paid models are defined as monthly dollar amounts. The table
below shows the monthly limit and token costs for each model.

Paid models have the following usage limits: 5-hour — 20% of the monthly limit;
