...
I limiti di utilizzo per i modelli a pagamento sono definiti come importi mensili in dollari. La tabella seguente mostra il limite mensile e i prezzi dei token per ciascun modello.

I modelli a pagamento hanno i seguenti limiti di utilizzo: 5 ore — 20% del limite mensile; settimanale — 50%; mensile — 100%.
