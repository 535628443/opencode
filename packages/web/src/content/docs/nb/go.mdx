...
Bruksgrenser for betalte modeller defineres som månedlige dollarbeløp. Tabellen nedenfor viser den månedlige grensen og tokenkostnadene for hver modell.

Betalte modeller har følgende bruksgrenser: 5-timersgrense — 20 % av den månedlige grensen; ukentlig grense — 50 %; og månedlig grense — 100 %.
