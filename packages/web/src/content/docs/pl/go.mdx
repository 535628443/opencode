...
Limity użycia płatnych modeli są określane jako miesięczne kwoty w dolarach. Poniższa tabela przedstawia miesięczny limit i koszty tokenów dla każdego modelu.

Płatne modele mają następujące limity użycia: 5-godzinny — 20% miesięcznego limitu; tygodniowy — 50%; miesięczny — 100%.
