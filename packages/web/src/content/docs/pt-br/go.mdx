...
Os limites de uso dos modelos pagos são definidos como valores mensais em dólares. A tabela abaixo mostra o limite mensal e os custos de tokens de cada modelo.

Os modelos pagos têm os seguintes limites de uso: 5 horas — 20% do limite mensal; semanal — 50%; e mensal — 100%.
