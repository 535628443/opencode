...
ขีดจำกัดการใช้งานสำหรับโมเดลแบบชำระเงินกำหนดเป็นจำนวนเงินดอลลาร์รายเดือน ตารางด้านล่างแสดงขีดจำกัดรายเดือนและค่า token ของแต่ละโมเดล

โมเดลแบบชำระเงินมีขีดจำกัดการใช้งานดังนี้: 5 ชั่วโมง — 20% ของขีดจำกัดรายเดือน; รายสัปดาห์ — 50%; และรายเดือน — 100%
